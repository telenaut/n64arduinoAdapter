 ...
 *
 * Updated N64 to HID by Telenaut, June 2020



 * To use, connect the N64 controller to your microcontroller in the following way:
 * MCU ground    -->  N64 controller ground
 * Digital I/O 2 -->  N64 serial line
 * MCU 3.3v      -->  N64 controller power

                    [VIEW OF THE END OF THE N64 CONTROLLER PLUG]
...
Controller:         GROUND          SERIAL LINE           3.3V
                       |                |                  |
                       |                |                  |
                       |                |                  |
MCU:                GROUND         DIGITAL I/O 2          3.3V
...
// These two macros set MCU pin 2 to input or output, which with an
...
void setup(){
    ...
    // To this end, upload this code to your microcontroller BEFORE connecting the controller
    digitalWrite(N64_PIN, LOW);
    pinMode(N64_PIN, INPUT);


    // Initialize the controller by sending it a null byte.
    ...
    // Query for the controller's status. We do this
